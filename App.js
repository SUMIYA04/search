    ...
    <div className="App">
      ...
      <ul>
        {searchResults.map((country, index) => (
          <li key={index}>
            <strong>{country.country}</strong> - Capital: {country.capital}, Population: {country.population.toLocaleString()}, Language(s): {Array.isArray(country.official_language) ? country.official_language.join(', ') : country.official_language}, Currency: {country.currency}
          </li>
        ))}
      </ul>
    </div>
